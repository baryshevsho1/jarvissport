# Generated by Django 5.1.7 on 2025-03-12 12:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.PositiveIntegerField(default=0, help_text='Время в минутах')),
                ('weight', models.DecimalField(blank=True, decimal_places=1, max_digits=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exercise_weight', models.DecimalField(blank=True, decimal_places=1, max_digits=5, null=True)),
                ('exercise_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='fitnessapp.exercisetype')),
